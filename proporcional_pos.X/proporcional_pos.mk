...
MAKECMD 			 = "C:/Program Files/MATLAB/R2013a/bin/win64/gmake"
HOST             = PC
#HOST 			 = ANY
BUILD            = yes
...
#
MODEL                   = proporcional_pos
MODULES                 = MCHP_UART2_Interrupt.c proporcional_pos_data.c proporcional_pos_main.c 
#MODULES_OBJ		    = MCHP_UART2_Interrupt.obj proporcional_pos_data.obj proporcional_pos_main.obj 
MAKEFILE                = proporcional_pos.mk
MATLAB_ROOT             = C:/Program Files/MATLAB/R2013a
ALT_MATLAB_ROOT         = C:/PROGRA~1/MATLAB/R2013a
MASTER_ANCHOR_DIR       = 
START_DIR               = C:/Users/user/DOCUME~1/MATLAB/Control/parcial 2
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 0
...
MODELLIB                  = proporcional_poslib_lib.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
GCCPATH	= C:/PROGRA~2/Microchip/xc16/v1.26/bin
ifeq ($(strip $(GCCPATH)),)
	CC   = $(GCC1)
	CPP  = $(GCC1)
	LD   = $(GCC1)
...
LINKER_SCRIPT 	= "C:/PROGRA~2/Microchip/xc16/v1.26/support/dsPIC30F/gld/p30F4011.gld"
PIC_LIB 		= C:/PROGRA~2/Microchip/xc16/v1.26/lib/libpic30-elf.a C:/PROGRA~2/Microchip/xc16/v1.26/lib/libm-elf.a C:/PROGRA~2/Microchip/xc16/v1.26/lib/libc-elf.a C:/PROGRA~2/Microchip/xc16/v1.26/lib/libq-elf.a C:/PROGRA~2/Microchip/xc16/v1.26/lib/libq-dsp-elf.a 
PIC_INCLUDES 	= -IC:/PROGRA~2/Microchip/xc16/v1.26/include -IC:/PROGRA~2/Microchip/xc16/v1.26/support/dsPIC30F/h -IC:/PROGRA~2/Microchip/xc16/v1.26/support/generic/h
PIC_REF 		= 30F4011
...
#
ADD_INCLUDES = \
	-I$(START_DIR)/proporcional_pos.X \
	-I$(START_DIR) \
	-IC:/Users/user/Documents/MATLAB/Control/Motor \
...
#ASM_OPTIM_SRCS = 
#
#ASM_OPTIM_SRCS += $(wildcard $(START_DIR)/proporcional_pos.X/*.s) 
#ASM_OPTIM_SRCS += $(wildcard $(START_DIR)/*.s) 
#ASM_OPTIM_SRCS += $(wildcard C:/Users/user/Documents/MATLAB/Control/Motor/*.s) 
